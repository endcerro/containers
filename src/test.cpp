...
int     main()
{
 ...
 //  		std::cout << "total: " << sum << '\n';
	...
	std::cout << "======================================================\033[37m\n" << std::endl;
	{
		...
		// list1.splice(lit, list2);								
		// mylist2.splice (mylist2.begin(),mylist1, it);
		// list2.splice (list2.begin(),list1, lit);
		...
		// std::cout << "\nlist1 contains:";
		// for (lit = --list1.end(); lit!=list1.begin(); --lit)
		// 	std::cout << ' ' << *lit;
		// std::cout << ' ' << *lit;
		// std::cout << "\nsize list = " 
		...
		// 	std::cout << ' ' << *lit;
		// std::cout << ' ' << *lit;
		// std::cout << "\nsize list = " << list1.size() << std::endl;

		// std::cout << "\nlist2 contains:";
		// for (lit=list2.begin(); lit!=list2.end(); ++lit)
		// 	std::cout << ' ' << *lit;
		
		// std::cout << "\nlist2 contains:";
		// for (lit = --list2.end(); lit!=list2.begin(); --lit)
		// 	std::cout << ' ' << *lit;
		// std::cout << ' ' << *lit;
		// std::cout << "\nsize list = " << list2.size() << std::endl;
